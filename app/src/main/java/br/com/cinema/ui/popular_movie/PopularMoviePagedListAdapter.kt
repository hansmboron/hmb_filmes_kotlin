...
import br.com.cinema.ui.single_movie_detail.SingleMovie
...
class PopularMoviePagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class NetworkStateItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(networkState: NetworkState?) {
            val errorMessageItem = itemView.findViewById<TextView>(R.id.error_msg_item)
            val progressItemBar = itemView.findViewById<ProgressBar>(R.id.progress_bar_item)

            if (networkState != null && networkState == NetworkState.LOADING) {
                progressItemBar.visibility  = View.VISIBLE;
            }
            else  {
                progressItemBar.visibility = View.GONE;
            }

            if (networkState != null && networkState == NetworkState.ERROR) {
                errorMessageItem.visibility = View.VISIBLE;
                errorMessageItem.text = networkState.msg;
            }
                ...
                errorMessageItem.visibility = View.GONE;
            }
        }
    }
